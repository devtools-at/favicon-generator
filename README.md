...
<p align="center">
  <a href="https://devtools.at/tools/favicon-generator"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Generate favicons from images</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/favicon-generator">Try Online</a> •
...
**[Try Favicon Generator online at DevTools.at →](https://devtools.at/tools/favicon-generator)**
...
Generate favicons from images. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/favicon-generator';
